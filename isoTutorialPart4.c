/*
 *  Isometric Game Tutorial Part 4
 *  Author: Johan Forsblom
 *  Written: 30 April and August 2018
 *
 ...
 *   - (Removed) Left click - center map to tile under mouse (Not present in part 3, might be added later again if needed)
 *
...
void init()
{
    ...
    texturePoolAddTextureToTexturePool(game.texturePool,"data/character2.png");
...
/// PLAYER ENTITY
    ...
    entity = ecsSceneAddEntityToScene(testScene,
             ...
             COMPONENT_SET1_NAMETAG | COMPONENT_SET1_KEYBOARD |COMPONENT_SET1_RENDER2D | COMPONENT_SET1_COLLISION);
    ...
    componentRender2DSetTextureAndClipRect(render,entity,texturePoolGetTextureFromPool(game.texturePool,"character2.png"),&tmpRect);
...
/// TREES ON THE MAP!
    ...
    for(i=0;i<200;++i)
    {
        ...
        componentPositionSetPosition(position,entity,rand()%2032,rand()%2032);
    ...
    //create an empty map
    testScene->isoEngine->isoMap = isoMapCreateEmptyMap("Testmap",MAP_WIDTH,MAP_HEIGHT,2,64);
...
int main(int argc, char *argv[])
{
    ...
    initSDL("Isometric Game Tutorial - Part 3 - By Johan Forsblom");
    init();
